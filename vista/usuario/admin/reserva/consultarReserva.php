...
<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Reservas</h1>
        </div>
              ...
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-primary" href="?c=reserva&a=Prestar&id=<?=$r->reserva_id?>&ejemcu=<?=$r->ejemp_codigounico?>"><i class="fa fa-lg fa-trash"></i></a>    
                    </td>                    
                  </tr>
                <?php endforeach;?>
                </tbody>
