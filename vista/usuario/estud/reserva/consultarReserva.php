              ...
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                ?>
                  <tr>
                    ...
                    <td>
                    <a class="btn btn-primary" href="?c=reservaEst&a=Reserva&id=<?=$r->reserva_id?>"><i class="fa fa-lg fa-edit"></i></a>
                    <a class="btn btn-primary" href="?c=reservaEst&a=EliminarReserva&id=<?=$r->reserva_id?>&ejemcu=<?=$r->ejemp_codigounico?>"><i class="fa fa-lg fa-trash"></i></a>    
                    </td>                    
                  </tr>
                <?php endforeach;?>
                </tbody>
