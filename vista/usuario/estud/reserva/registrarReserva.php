      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="row">
              <div class="col-lg-6">
                <form method="POST" action="?c=reservaEst&a=GuardarReserva">
                  <div class="form-group">                      
                    ...
                    <div class="form-group">
                        ...
                        <input disabled required class="form-control" name="libro_titulo" type="text" value="<?=$re1->libro_titulo ?>">
                    </div> 

                    <div class="form-group">
                        <label for="codigo">Código Ejemplar</label>
                        <input disabled class="form-control" name="codigo" type="text" value="<?=$re3->ejemp_codigounico ?>">
                    </div> 
